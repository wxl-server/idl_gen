...
func (p *ValidateTokenReq) InitDefault() {
}

func (p *ValidateTokenReq) GetToken() (v string) {
	return p.Token
}
func (p *ValidateTokenReq) SetToken(val string) {
	p.Token = val
}

var fieldIDToName_ValidateTokenReq = map[int16]string{
	1: "token",
}

func (p *ValidateTokenReq) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_ValidateTokenReq[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
ReadStructEndError:
	return thrift.PrependError(fmt.Sprintf("%T read struct end error: ", p), err)
RequiredFieldNotSetError:
	return thrift.NewTProtocolExceptionWithType(thrift.INVALID_DATA, fmt.Errorf("required field %s is not set", fieldIDToName_ValidateTokenReq[fieldId]))
}

func (p *ValidateTokenReq) ReadField1(iprot thrift.TProtocol) error {
...
func (p *ValidateTokenReq) Write(oprot thrift.TProtocol) (err error) {

	var fieldId int16
	if err = oprot.WriteStructBegin("ValidateTokenReq"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *ValidateTokenReq) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("token", thrift.STRING, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := oprot.WriteString(p.Token); err != nil {
...
func (p *ValidateTokenReq) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("ValidateTokenReq(%+v)", *p)

}

func (p *ValidateTokenReq) DeepEqual(ano *ValidateTokenReq) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *ValidateTokenReq) Field1DeepEqual(src string) bool {
...
type ValidateTokenResp struct {
	Claims map[string]string `thrift:"claims,1,required" frugal:"1,required,map<string:string>" json:"claims"`
}

func NewValidateTokenResp() *ValidateTokenResp {
	return &ValidateTokenResp{}
}

func (p *ValidateTokenResp) InitDefault() {
}

func (p *ValidateTokenResp) GetClaims() (v map[string]string) {
	return p.Claims
}
func (p *ValidateTokenResp) SetClaims(val map[string]string) {
	p.Claims = val
}

var fieldIDToName_ValidateTokenResp = map[int16]string{
	1: "claims",
}

func (p *ValidateTokenResp) Read(iprot thrift.TProtocol) (err error) {

	var fieldTypeId thrift.TType
	var fieldId int16
	var issetClaims bool = false
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_ValidateTokenResp[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
ReadStructEndError:
	return thrift.PrependError(fmt.Sprintf("%T read struct end error: ", p), err)
RequiredFieldNotSetError:
	return thrift.NewTProtocolExceptionWithType(thrift.INVALID_DATA, fmt.Errorf("required field %s is not set", fieldIDToName_ValidateTokenResp[fieldId]))
}

func (p *ValidateTokenResp) ReadField1(iprot thrift.TProtocol) error {
...
func (p *ValidateTokenResp) Write(oprot thrift.TProtocol) (err error) {

	var fieldId int16
	if err = oprot.WriteStructBegin("ValidateTokenResp"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *ValidateTokenResp) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("claims", thrift.MAP, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := oprot.WriteMapBegin(thrift.STRING, thrift.STRING, len(p.Claims)); err != nil {
		return err
	}
...
func (p *ValidateTokenResp) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("ValidateTokenResp(%+v)", *p)

}

func (p *ValidateTokenResp) DeepEqual(ano *ValidateTokenResp) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
	}
	if !p.Field1DeepEqual(ano.Claims) {
		return false
	}
	return true
}

func (p *ValidateTokenResp) Field1DeepEqual(src map[string]string) bool {

	if len(p.Claims) != len(src) {
		return false
	}
	for k, v := range p.Claims {
		_src := src[k]
...
type CommonUser interface {
	...
	ValidateToken(ctx context.Context, req *ValidateTokenReq) (r *ValidateTokenResp, err error)
}
...
type CommonUserValidateTokenArgs struct {
	Req *ValidateTokenReq `thrift:"req,1" frugal:"1,default,ValidateTokenReq" json:"req"`
}

func NewCommonUserValidateTokenArgs() *CommonUserValidateTokenArgs {
	return &CommonUserValidateTokenArgs{}
}

func (p *CommonUserValidateTokenArgs) InitDefault() {
}

var CommonUserValidateTokenArgs_Req_DEFAULT *ValidateTokenReq

func (p *CommonUserValidateTokenArgs) GetReq() (v *ValidateTokenReq) {
	if !p.IsSetReq() {
		return CommonUserValidateTokenArgs_Req_DEFAULT
	}
	return p.Req
}
func (p *CommonUserValidateTokenArgs) SetReq(val *ValidateTokenReq) {
	p.Req = val
}

var fieldIDToName_CommonUserValidateTokenArgs = map[int16]string{
	1: "req",
}

func (p *CommonUserValidateTokenArgs) IsSetReq() bool {
	return p.Req != nil
}

func (p *CommonUserValidateTokenArgs) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_CommonUserValidateTokenArgs[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *CommonUserValidateTokenArgs) ReadField1(iprot thrift.TProtocol) error {
...
func (p *CommonUserValidateTokenArgs) Write(oprot thrift.TProtocol) (err error) {
...
func (p *CommonUserValidateTokenArgs) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("req", thrift.STRUCT, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := p.Req.Write(oprot); err != nil {
...
func (p *CommonUserValidateTokenArgs) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("CommonUserValidateTokenArgs(%+v)", *p)

}

func (p *CommonUserValidateTokenArgs) DeepEqual(ano *CommonUserValidateTokenArgs) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *CommonUserValidateTokenArgs) Field1DeepEqual(src *ValidateTokenReq) bool {
...
type CommonUserValidateTokenResult struct {
	Success *ValidateTokenResp `thrift:"success,0,optional" frugal:"0,optional,ValidateTokenResp" json:"success,omitempty"`
}

func NewCommonUserValidateTokenResult() *CommonUserValidateTokenResult {
	return &CommonUserValidateTokenResult{}
}

func (p *CommonUserValidateTokenResult) InitDefault() {
}

var CommonUserValidateTokenResult_Success_DEFAULT *ValidateTokenResp

func (p *CommonUserValidateTokenResult) GetSuccess() (v *ValidateTokenResp) {
	if !p.IsSetSuccess() {
		return CommonUserValidateTokenResult_Success_DEFAULT
	}
	return p.Success
}
func (p *CommonUserValidateTokenResult) SetSuccess(x interface{}) {
	p.Success = x.(*ValidateTokenResp)
}

var fieldIDToName_CommonUserValidateTokenResult = map[int16]string{
	0: "success",
}

func (p *CommonUserValidateTokenResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *CommonUserValidateTokenResult) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_CommonUserValidateTokenResult[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *CommonUserValidateTokenResult) ReadField0(iprot thrift.TProtocol) error {
...
func (p *CommonUserValidateTokenResult) Write(oprot thrift.TProtocol) (err error) {
...
func (p *CommonUserValidateTokenResult) writeField0(oprot thrift.TProtocol) (err error) {
	if p.IsSetSuccess() {
		if err = oprot.WriteFieldBegin("success", thrift.STRUCT, 0); err != nil {
			goto WriteFieldBeginError
		}
...
func (p *CommonUserValidateTokenResult) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("CommonUserValidateTokenResult(%+v)", *p)

}

func (p *CommonUserValidateTokenResult) DeepEqual(ano *CommonUserValidateTokenResult) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *CommonUserValidateTokenResult) Field0DeepEqual(src *ValidateTokenResp) bool {
