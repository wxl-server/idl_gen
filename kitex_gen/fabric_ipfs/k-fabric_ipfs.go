...
func (p *CreateCreateEblDocxDocxReq) FastRead(buf []byte) (int, error) {
...
ReadFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_CreateCreateEblDocxDocxReq[fieldId]), err)
SkipFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
RequiredFieldNotSetError:
	return offset, thrift.NewProtocolException(thrift.INVALID_DATA, fmt.Sprintf("required field %s is not set", fieldIDToName_CreateCreateEblDocxDocxReq[fieldId]))
}

func (p *CreateCreateEblDocxDocxReq) FastReadField1(buf []byte) (int, error) {
	offset := 0
...
func (p *CreateCreateEblDocxDocxReq) FastWrite(buf []byte) int {
	return p.FastWriteNocopy(buf, nil)
}

func (p *CreateCreateEblDocxDocxReq) FastWriteNocopy(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	if p != nil {
...
func (p *CreateCreateEblDocxDocxReq) BLength() int {
	l := 0
	if p != nil {
		l += p.field1Length()
	}
...
func (p *CreateCreateEblDocxDocxReq) fastWriteField1(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
...
func (p *CreateCreateEblDocxDocxReq) field1Length() int {
	l := 0
...
func (p *CreateCreateEblDocxDocxResp) FastRead(buf []byte) (int, error) {
...
ReadFieldBeginError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_CreateCreateEblDocxDocxResp[fieldId]), err)
SkipFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
RequiredFieldNotSetError:
	return offset, thrift.NewProtocolException(thrift.INVALID_DATA, fmt.Sprintf("required field %s is not set", fieldIDToName_CreateCreateEblDocxDocxResp[fieldId]))
}

func (p *CreateCreateEblDocxDocxResp) FastReadField1(buf []byte) (int, error) {
	offset := 0
...
func (p *CreateCreateEblDocxDocxResp) FastWrite(buf []byte) int {
	return p.FastWriteNocopy(buf, nil)
}

func (p *CreateCreateEblDocxDocxResp) FastWriteNocopy(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	if p != nil {
		offset += p.fastWriteField1(buf[offset:], w)
	}
...
func (p *CreateCreateEblDocxDocxResp) BLength() int {
	l := 0
	if p != nil {
		l += p.field1Length()
	}
...
func (p *CreateCreateEblDocxDocxResp) fastWriteField1(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
...
func (p *CreateCreateEblDocxDocxResp) field1Length() int {
	l := 0
	l += thrift.Binary.FieldBeginLength()
...
func (p *FabricCreateEblDocxCreateCreateEblDocxDocxArgs) FastRead(buf []byte) (int, error) {
...
ReadFieldBeginError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_FabricCreateEblDocxCreateCreateEblDocxDocxArgs[fieldId]), err)
SkipFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
}

func (p *FabricCreateEblDocxCreateCreateEblDocxDocxArgs) FastReadField1(buf []byte) (int, error) {
	offset := 0
...
func (p *FabricCreateEblDocxCreateCreateEblDocxDocxArgs) FastWrite(buf []byte) int {
	return p.FastWriteNocopy(buf, nil)
}

func (p *FabricCreateEblDocxCreateCreateEblDocxDocxArgs) FastWriteNocopy(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	if p != nil {
		offset += p.fastWriteField1(buf[offset:], w)
	}
...
func (p *FabricCreateEblDocxCreateCreateEblDocxDocxArgs) BLength() int {
	l := 0
	if p != nil {
		l += p.field1Length()
	}
...
func (p *FabricCreateEblDocxCreateCreateEblDocxDocxArgs) fastWriteField1(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	offset += thrift.Binary.WriteFieldBegin(buf[offset:], thrift.STRUCT, 1)
...
func (p *FabricCreateEblDocxCreateCreateEblDocxDocxArgs) field1Length() int {
	l := 0
	l += thrift.Binary.FieldBeginLength()
	l += p.Req.BLength()
	return l
...
func (p *FabricCreateEblDocxCreateCreateEblDocxDocxResult) FastRead(buf []byte) (int, error) {
...
ReadFieldBeginError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_FabricCreateEblDocxCreateCreateEblDocxDocxResult[fieldId]), err)
SkipFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
}

func (p *FabricCreateEblDocxCreateCreateEblDocxDocxResult) FastReadField0(buf []byte) (int, error) {
	offset := 0
...
func (p *FabricCreateEblDocxCreateCreateEblDocxDocxResult) FastWrite(buf []byte) int {
	return p.FastWriteNocopy(buf, nil)
}

func (p *FabricCreateEblDocxCreateCreateEblDocxDocxResult) FastWriteNocopy(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	if p != nil {
...
func (p *FabricCreateEblDocxCreateCreateEblDocxDocxResult) BLength() int {
	l := 0
	if p != nil {
		l += p.field0Length()
	}
...
func (p *FabricCreateEblDocxCreateCreateEblDocxDocxResult) fastWriteField0(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	if p.IsSetSuccess() {
...
func (p *FabricCreateEblDocxCreateCreateEblDocxDocxResult) field0Length() int {
	l := 0
	if p.IsSetSuccess() {
		l += thrift.Binary.FieldBeginLength()
		l += p.Success.BLength()
...
func (p *FabricCreateEblDocxCreateCreateEblDocxDocxArgs) GetFirstArgument() interface{} {
	return p.Req
}

func (p *FabricCreateEblDocxCreateCreateEblDocxDocxResult) GetResult() interface{} {
	return p.Success
}
