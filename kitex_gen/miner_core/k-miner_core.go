...
func (p *GetItemReq) FastReadField255(buf []byte) (int, error) {
	offset := 0
	_field := base.NewBase()
...
func (p *GetItemReq) fastWriteField255(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
...
func (p *GetItemReq) field255Length() int {
	l := 0
	l += thrift.Binary.FieldBeginLength()
	l += p.Base.BLength()
	return l
